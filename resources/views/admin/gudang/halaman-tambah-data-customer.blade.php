        ...
        <div class="header-inner1">
          <div class="frame-parent14">
            ...
            <form action="{{ route('logout') }}" method="POST">
              @csrf
              <button class="tombol-logout" style="background: none; border: none; cursor: pointer;" type="submit">
                    ...
                    if (imgArray.length > maxLength) {
                        ...
                        if (len > maxLength) {
                            ...
                            reader.onload = function(e) {
                                var html = 
                                "<div class='photos-11' data-number='" + $(".upload__img-close").length +"' data-file='" + f.name + "' ><div class='nama-file-gambar5'> " + f.name + " </div><img class='gambar-icon5' src='" 
                                + e.target.result + 
